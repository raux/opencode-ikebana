...
export const dict = {
  ...
  "go.supported.title": "โมเดลที่รองรับ",
  "go.supported.model": "โมเดล",
  "go.supported.source": "แหล่งที่มา",
  "go.supported.selfHosted": "โฮสต์เอง ไม่ได้ควอนไทซ์",
  "go.supported.official": "API อย่างเป็นทางการ",
