...
export const dict = {
  ...
  "go.banner.text": "GLM-5.1 — รับขีดจำกัดการใช้งาน 2 เท่าถึงวันที่ 20 เมษายน",
  "go.hero.title": "โมเดลเขียนโค้ดราคาประหยัดสำหรับทุกคน",
  "go.hero.body":
    "Go นำการเขียนโค้ดแบบเอเจนต์มาสู่นักเขียนโปรแกรมทั่วโลก พร้อมมอบขีดจำกัดที่กว้างขวางและการเข้าถึงโมเดลโอเพนซอร์สที่ทรงพลังที่สุดได้อย่างน่าเชื่อถือ โดยส่งมอบมาแบบเต็มประสิทธิภาพและไม่มีการควอนไทซ์ เพื่อให้คุณสามารถสร้างสรรค์ด้วยเอเจนต์ที่ทรงพลังโดยไม่ต้องกังวลเรื่องค่าใช้จ่ายหรือความพร้อมใช้งาน",
