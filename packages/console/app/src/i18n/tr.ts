...
export const dict = {
  ...
  "go.supported.title": "Desteklenen modeller",
  "go.supported.model": "Model",
  "go.supported.source": "Kaynak",
  "go.supported.selfHosted": "Kendi barındırma, nicemlendirilmemiş",
  "go.supported.official": "Resmi API",
