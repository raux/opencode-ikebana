...
export const dict = {
  ...
  "go.supported.title": "Obsługiwane modele",
  "go.supported.model": "Model",
  "go.supported.source": "Źródło",
  "go.supported.selfHosted": "Hostowane przez nas, bez kwantyzacji",
  "go.supported.official": "Oficjalne API",
