...
export const dict = {
  ...
  "go.banner.text": "GLM-5.1 — лимиты использования 2x до 20 апреля",
  "go.hero.title": "Недорогие модели для кодинга для всех",
  "go.hero.body":
    "Go приносит агентное программирование разработчикам по всему миру, предлагая щедрые лимиты и надежный доступ к самым мощным open-source моделям, не подвергнутым квантованию и предоставляемым в полном объеме возможностей, чтобы вы могли создавать проекты с мощными агентами, не беспокоясь о стоимости или доступности.",
