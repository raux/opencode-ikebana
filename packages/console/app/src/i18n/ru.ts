...
export const dict = {
  ...
  "go.supported.title": "Поддерживаемые модели",
  "go.supported.model": "Модель",
  "go.supported.source": "Источник",
  "go.supported.selfHosted": "Размещается нами, без квантования",
  "go.supported.official": "Официальный API",
