...
export const dict = {
  ...
  "go.banner.text": "GLM-5.1 — احصل على حدود استخدام مضاعفة حتى 20 أبريل",
  "go.hero.title": "نماذج برمجة منخفضة التكلفة للجميع",
  "go.hero.body":
    "يجلب Go البرمجة الوكيلة إلى المبرمجين حول العالم، مع حدود سخية ووصول موثوق إلى أقوى نماذج المصدر المفتوح، المقدمة بكامل قدراتها ومن دون تكميم، حتى تتمكن من البناء باستخدام وكلاء أقوياء دون القلق بشأن التكلفة أو التوفر.",
