...
export const dict = {
  ...
  "go.supported.title": "النماذج المدعومة",
  "go.supported.model": "النموذج",
  "go.supported.source": "المصدر",
  "go.supported.selfHosted": "استضافة ذاتية، دون تكميم",
  "go.supported.official": "واجهة API الرسمية",
